package com.zhi.framework.manager.factory;

import java.util.TimerTask;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.zhi.common.constant.Constants;
import com.zhi.common.utils.LogUtils;
import com.zhi.common.utils.ServletUtils;
import com.zhi.common.utils.StringUtils;
import com.zhi.common.utils.http.UserAgentUtils;
...
public class AsyncFactory
{
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
            final Object... args)
    {
        final String userAgentStr = ServletUtils.getRequest().getHeader("User-Agent");
        ...
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                // 获取客户端操作系统
                String os = UserAgentUtils.getOperatingSystem(userAgentStr);
                // 获取客户端浏览器
                String browser = UserAgentUtils.getBrowser(userAgentStr);
                // 封装对象

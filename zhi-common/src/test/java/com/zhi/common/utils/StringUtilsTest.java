...
public class StringUtilsTest {
    ...
    public void testIsEmptyCollection() {
        ...
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(list1));
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(list2));
        assertFalse(com.zhi.common.utils.StringUtils.isEmpty(list3));
    }
    ...
    public void testIsNotEmptyCollection() {
        ...
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(list1));
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(list2));
        assertTrue(com.zhi.common.utils.StringUtils.isNotEmpty(list3));
    }
    ...
    public void testIsEmptyArray() {
        ...
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(arr1));
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(arr2));
        assertFalse(com.zhi.common.utils.StringUtils.isEmpty(arr3));
    }
    ...
    public void testIsNotEmptyArray() {
        ...
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(arr1));
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(arr2));
        assertTrue(com.zhi.common.utils.StringUtils.isNotEmpty(arr3));
    }
    ...
    public void testIsEmptyMap() {
        ...
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(map1));
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(map2));
        assertFalse(com.zhi.common.utils.StringUtils.isEmpty(map3));
    }
    ...
    public void testIsNotEmptyMap() {
        ...
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(map1));
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(map2));
        assertTrue(com.zhi.common.utils.StringUtils.isNotEmpty(map3));
    }

    @Test
    public void testIsEmptyString() {
        // 测试字符串是否为空
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty((String)null));
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty(""));
        assertTrue(com.zhi.common.utils.StringUtils.isEmpty("   "));
        assertFalse(com.zhi.common.utils.StringUtils.isEmpty("test"));
    }

    @Test
    public void testIsNotEmptyString() {
        // 测试字符串是否非空
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty((String)null));
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty(""));
        assertFalse(com.zhi.common.utils.StringUtils.isNotEmpty("   "));
        assertTrue(com.zhi.common.utils.StringUtils.isNotEmpty("test"));
    }
    ...
    public void testContainsAny() {
        ...
        assertTrue(com.zhi.common.utils.StringUtils.containsAny(collection, "a", "d"));
        assertTrue(com.zhi.common.utils.StringUtils.containsAny(collection, "d", "b"));
        assertFalse(com.zhi.common.utils.StringUtils.containsAny(collection, "d", "e"));
        assertFalse(com.zhi.common.utils.StringUtils.containsAny((Collection<String>)null, "a", "b"));
        assertFalse(com.zhi.common.utils.StringUtils.containsAny(collection, (String[]) null));
    }

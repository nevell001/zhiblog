...
// 带压缩的图片上传
export function uploadCompressed(data) {
  return request({
...
// 移动端适配图片上传
export function uploadMobileImage(data) {
  return request({
...
// 带水印图片上传
export function uploadWatermarkImage(data, watermarkText) {
  return request({
...
// 图片格式转换
export function convertImageFormat(data, targetFormat) {
  return request({

    ...
    <nav class="blog-top-nav">
      <div class="nav-inner">
        <router-link to="/blog" class="nav-left">
          <div class="brand-logo">{{ blogSettings.blog_name?.charAt(0) || '博' }}</div>
        ...
        <div class="nav-right">
          ...
          <button class="theme-btn" @click="toggleTheme" :title="isDark ? '切换亮色' : '切换深色'">
            <svg
              v-if="isDark"
              width="18"
              height="18"
    ...
    <footer class="blog-site-footer">
      ...
      <div class="footer-inner">
        <div class="footer-brand">
          <div class="footer-logo">{{ blogSettings.blog_name?.charAt(0) || '博' }}</div>
          <div class="brand-text">
            <span class="brand-name">{{ blogSettings.blog_name || '我的博客' }}</span>
            <p class="brand-desc">{{ blogSettings.blog_desc || '分享技术与生活的点滴' }}</p>
          </div>
        </div>

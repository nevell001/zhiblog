...
export const apiUtils = {
  ...
  getApi: (module, submodule, action) => {
    ...
    if (submodule && !apiConfig[module][submodule]) return null
    if (action && submodule && apiConfig[module][submodule][action]) {
      return apiConfig.baseURL + apiConfig[module][submodule][action]
    }
    if (submodule && !action) {
      return apiConfig.baseURL + apiConfig[module][submodule]
    }
    return apiConfig.baseURL + apiConfig[module]
  }
}

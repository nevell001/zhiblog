      ...
      >
          ...
          >
            ...
            >
              <el-input
                ...
                placeholder="请输入博客访问地址"
              />
            </el-form-item>
            <el-form-item
              label="创建时间"
              prop="blog_start_time"
            >
              <el-date-picker
            ...
            >
              <el-input
                v-model="settingsMap.blog_signature"
                placeholder="请输入博主签名"
              />
            </el-form-item>
          </el-form>
        ...
        >
          ...
          >
            ...
            >
              <el-input
                v-model="settingsMap.seo_robots"
                placeholder="如：index,follow"
              />
            </el-form-item>
            <el-form-item
              label="网站图标"
        ...
        >
          ...
          >
            ...
            <el-form-item
              label="头部背景色"
              prop="header_background"
            >
              <el-color-picker
                v-model="settingsMap.header_background"
                show-alpha
              />
            </el-form-item>
            <el-form-item
        ...
        >
          ...
          >
            ...
            <el-form-item
              label="欢迎信息"
              prop="greeting_message"
            >
              <el-input
                v-model="settingsMap.greeting_message"
                placeholder="请输入欢迎信息"
              />
            </el-form-item>
            <el-form-item

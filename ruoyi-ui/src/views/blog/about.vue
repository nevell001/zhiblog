    ...
    <div class="about-page">
      ...
      <header class="hero-section">
        ...
        <div class="hero-inner">
          ...
          <h1 class="hero-name">{{ blogSettings.blog_author || 'Nevell' }}</h1>
          <p class="hero-role">{{ blogSettings.author_title || '全栈开发工程师' }}</p>
          <p class="hero-desc">
      ...
      <section class="stats-section">
        <div class="stats-inner">
          ...
          <div v-animate="'fade-in-up'" class="stat-item">
            <div class="stat-num">{{ formatNumber(stats.totalViews || 0) }}</div>
      ...
      <section class="contact-section">
        <div class="contact-inner">
          ...
          <div class="contact-grid">
            <div class="contact-card" v-if="blogSettings.blog_email">
            ...
            <div class="contact-card" v-if="blogSettings.author_location">
              ...
              <div class="contact-info">
                ...
                <div class="contact-value">{{ blogSettings.author_location }}</div>
              </div>
            </div>
            <div class="contact-card" v-if="blogSettings.github_url">
            ...
            <div class="contact-card" v-if="blogSettings.weibo_url">
            ...
            <div class="contact-card" v-if="blogSettings.personal_website">

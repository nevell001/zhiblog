<template>
  <div class="debug-container">
    ...
    <div class="test-section">
      <h3>测试对象：</h3>
      <el-button @click="testUndefinedOn" type="danger">测试 undefined.on()</el-button>
      <el-button @click="testNullOn" type="warning">测试 null.on()</el-button>
      <el-button @click="testAPI" type="primary">测试 API 导入</el-button>
    </div>

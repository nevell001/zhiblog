...
window.testMenuFix = {
  ...
  checkMenuConfig() {
    ...
    const isValid =
      config.router === true && config.uniqueOpened === false && config.collapseTransition === false
  ...
  // 检查CSS样式
  checkStyles() {
    const styles = ['.el-sub-menu__title', '.el-sub-menu .el-menu', '.nest-menu .el-menu-item']

...
**Current Version**: v1.3.5 (as defined in pom.xml)
...
14. **Version Management**: Version defined in `pom.xml` (currently 1.3.5), sync with `application.yml` app.version for consistency. See `docs/VERSION_MANAGEMENT.md` for comprehensive version update instructions

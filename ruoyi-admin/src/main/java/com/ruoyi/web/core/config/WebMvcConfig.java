...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private static class SpaResourceResolver extends PathResourceResolver {
        ...
        protected Resource getResource(String resourcePath, Resource location) throws IOException {
            ...
            // 如果资源不存在，且不是API请求（不包含/api和不以下划线开头），返回index.html
            if (resource == null && !resourcePath.contains("/api") && !resourcePath.startsWith("/") && !resourcePath.contains(".")) {

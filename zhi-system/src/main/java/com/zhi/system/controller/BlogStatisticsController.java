...
public class BlogStatisticsController extends BaseController
{
    ...
    public AjaxResult getArticleCategoryDistribution()
    {
        try {
            ...
            // 查询分类列表（包含文章数量）
            List<com.zhi.system.domain.BlogCategory> categoryList = blogCategoryService.selectCategoryListForFront(new com.zhi.system.domain.BlogCategory());
            
            if (categoryList != null && !categoryList.isEmpty()) {
                List<String> labels = new ArrayList<>();
                List<Integer> data = new ArrayList<>();
                
                for (com.zhi.system.domain.BlogCategory category : categoryList) {

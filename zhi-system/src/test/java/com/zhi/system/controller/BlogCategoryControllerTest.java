...
class BlogCategoryControllerTest {
    ...
    void testGetCategoryList() throws Exception {
        ...
        verify(blogCategoryService).selectCategoryListForFront(any(com.zhi.system.domain.BlogCategory.class));
    }
    ...
    void testAddCategory() throws Exception {
        // 模拟成功添加
        when(blogCategoryService.insertBlogCategory(any(com.zhi.system.domain.BlogCategory.class)))
            .thenReturn(1);
        ...
        verify(blogCategoryService).insertBlogCategory(any(com.zhi.system.domain.BlogCategory.class));
    }
    ...
    void testEditCategory() throws Exception {
        // 模拟成功更新
        when(blogCategoryService.updateBlogCategory(any(com.zhi.system.domain.BlogCategory.class)))
            .thenReturn(1);
        ...
        verify(blogCategoryService).updateBlogCategory(any(com.zhi.system.domain.BlogCategory.class));
    }

...
class BlogFriendLinkControllerTest {
    ...
    void testGetFriendLinkList() throws Exception {
        // 模拟数据
        List<com.zhi.system.domain.BlogFriendLink> linkList = new ArrayList<>();
        com.zhi.system.domain.BlogFriendLink link = new com.zhi.system.domain.BlogFriendLink();
        link.setId(1L);
        link.setName("测试友情链接");
        link.setUrl("https://example.com");
        linkList.add(link);

        when(blogFriendLinkService.selectBlogFriendLinkList(any(com.zhi.system.domain.BlogFriendLink.class)))
            .thenReturn(linkList);
        ...
        verify(blogFriendLinkService).selectBlogFriendLinkList(any(com.zhi.system.domain.BlogFriendLink.class));
    }

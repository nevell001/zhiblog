...
class BlogTagControllerTest {
    ...
    void testGetTagList() throws Exception {
        // 模拟数据
        List<com.zhi.system.domain.BlogTag> tagList = new ArrayList<>();
        com.zhi.system.domain.BlogTag tag = new com.zhi.system.domain.BlogTag();
        tag.setId(1L);
        tag.setName("测试标签");
        tagList.add(tag);

        when(blogTagService.selectBlogTagList(any(com.zhi.system.domain.BlogTag.class)))
            .thenReturn(tagList);
        ...
        verify(blogTagService).selectBlogTagList(any(com.zhi.system.domain.BlogTag.class));
    }
    ...
    void testAddTag_Success() throws Exception {
        // 模拟标签名称唯一
        when(blogTagService.checkTagNameUnique(any(com.zhi.system.domain.BlogTag.class)))
            .thenReturn(true);
        when(blogTagService.insertBlogTag(any(com.zhi.system.domain.BlogTag.class)))
            .thenReturn(1);
        ...
        verify(blogTagService).insertBlogTag(any(com.zhi.system.domain.BlogTag.class));
    }
    ...
    void testAddTag_DuplicateName() throws Exception {
        ...
        verify(blogTagService, never()).insertBlogTag(any(com.zhi.system.domain.BlogTag.class));
    }
    ...
    void testEditTag_Success() throws Exception {
        ...
        when(blogTagService.checkTagNameUnique(any(com.zhi.system.domain.BlogTag.class)))
            .thenReturn(true);
        when(blogTagService.updateBlogTag(any(com.zhi.system.domain.BlogTag.class)))
            .thenReturn(1);
        ...
        verify(blogTagService).updateBlogTag(any(com.zhi.system.domain.BlogTag.class));
    }

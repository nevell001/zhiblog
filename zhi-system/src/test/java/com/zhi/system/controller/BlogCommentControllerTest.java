...
class BlogCommentControllerTest {
    ...
    void testGetCommentList() throws Exception {
        // 模拟数据
        List<com.zhi.system.domain.BlogComment> commentList = new ArrayList<>();
        com.zhi.system.domain.BlogComment comment = new com.zhi.system.domain.BlogComment();
        comment.setId(1L);
        comment.setContent("测试评论");
        commentList.add(comment);

        when(blogCommentService.selectBlogCommentList(any(com.zhi.system.domain.BlogComment.class)))
        ...
        verify(blogCommentService).selectBlogCommentList(any(com.zhi.system.domain.BlogComment.class));
    }
    ...
    void testAddComment() throws Exception {
        // 模拟成功添加
        when(blogCommentService.insertBlogComment(any(com.zhi.system.domain.BlogComment.class)))
            .thenReturn(1);
        ...
        verify(blogCommentService).insertBlogComment(any(com.zhi.system.domain.BlogComment.class));
    }
    ...
    void testEditComment() throws Exception {
        // 模拟成功更新
        when(blogCommentService.updateBlogComment(any(com.zhi.system.domain.BlogComment.class)))
            .thenReturn(1);
        ...
        verify(blogCommentService).updateBlogComment(any(com.zhi.system.domain.BlogComment.class));
    }

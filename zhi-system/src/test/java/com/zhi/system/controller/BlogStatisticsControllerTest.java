...
class BlogStatisticsControllerTest {
    ...
    @MockBean
    private com.zhi.system.service.IBlogArticleService blogArticleService;

    @MockBean
    private com.zhi.system.service.IBlogCategoryService blogCategoryService;

    @MockBean
    private com.zhi.system.service.IBlogTagService blogTagService;

    @MockBean
    private com.zhi.system.service.IBlogCommentService blogCommentService;

    @MockBean
    private com.zhi.system.service.ISysUserService userService;
    ...
    void testGetStatisticsOverview() throws Exception {
        // 模拟数据
        when(blogArticleService.selectBlogArticleCount(any(com.zhi.system.domain.BlogArticle.class)))
            .thenReturn(100L);
        when(userService.selectUserCount(any(com.zhi.common.core.domain.entity.SysUser.class)))
            .thenReturn(50L);
        when(blogCommentService.selectBlogCommentCount(any(com.zhi.system.domain.BlogComment.class)))
            .thenReturn(200L);
    ...
    void testGetArticleCategoryDistribution() throws Exception {
        // 模拟数据
        List<com.zhi.system.domain.BlogCategory> categoryList = new ArrayList<>();
        com.zhi.system.domain.BlogCategory category = new com.zhi.system.domain.BlogCategory();
        category.setName("技术");
        category.setArticleCount(20);
        categoryList.add(category);

        when(blogCategoryService.selectCategoryListForFront(any(com.zhi.system.domain.BlogCategory.class)))

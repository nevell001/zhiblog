...
class SysDictTypeServiceImplTest {
    ...
    void testSelectDictDataByType_FromCache() {
        ...
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            mockedDictUtils.when(() -> com.zhi.common.utils.DictUtils.getDictCache("sys_user_sex")).thenReturn(cachedData);
    ...
    void testSelectDictDataByType_FromDatabase() {
        ...
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            mockedDictUtils.when(() -> com.zhi.common.utils.DictUtils.getDictCache("sys_user_sex")).thenReturn(null);
            ...
            mockedDictUtils.verify(() -> com.zhi.common.utils.DictUtils.setDictCache(eq("sys_user_sex"), anyList()));
        }
    }
    ...
    void testSelectDictDataByType_NotFound() {
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            mockedDictUtils.when(() -> com.zhi.common.utils.DictUtils.getDictCache("non_existent")).thenReturn(null);
    ...
    void testDeleteDictTypeByIds() {
        ...
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            ...
            mockedDictUtils.verify(() -> com.zhi.common.utils.DictUtils.removeDictCache("sys_user_sex"));
        }
    }
    ...
    void testClearDictCache() {
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            ...
            mockedDictUtils.verify(com.zhi.common.utils.DictUtils::clearDictCache);
        }
    }
    ...
    void testInsertDictType() {
        ...
        try (MockedStatic<com.zhi.common.utils.DictUtils> mockedDictUtils = mockStatic(com.zhi.common.utils.DictUtils.class)) {
            ...
            mockedDictUtils.verify(() -> com.zhi.common.utils.DictUtils.setDictCache("sys_user_sex", null));
        }
    }
